...
```{r, echo = F}
demo_url <- "https://asvenning.shinyapps.io/lringsredskab_-_dansk_flora_og_vegetationskologi/?_ga=2.117524928.852255328.1662635286-946788904.1657455478"
```

<center><img src="https://github.com/asgersvenning/Dansk-Flora-App/blob/7e1e76d32a19635dcc2a007430eac904a7e9bb57/readme_files/learnDFV_Sticker.png?raw=true" width="250px"></center>

<br>

<center>
  <div style="font-size: 30px; font-weight: bold;">Demo: [shinyapps.io](`r demo_url`)</div> 
</center>
